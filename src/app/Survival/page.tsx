                    ...
                    <section>
                        ...
                        <div className="flex flex-col gap-4">
                            <div className="flex flex-row flex-wrap gap-2">
                                ...
                                <button type="button" className="flex-1 bg-spaceGold border border-blueBlack border-2 text-blueBlack p-1 rounded transform animate-fadeOut4">They are Coming</button>
                                <Image src="/images/orange-eye-spider.png" alt="hungry spider" className="flex-1 transform animate-fadeOut4" width={75} height={75} />
                                <button type="button" className="flex-1 bg-spaceGold border border-blueBlack border-2 text-blueBlack p-1 rounded animate-fadeOut2">A Small Taste</button>
                                <Image src="/images/orange-eye-spider.png" alt="hungry spider" className="flex-1 transform animate-fadeOut25" width={75} height={75} />
                                <Image src="/images/orange-eye-spider.png" alt="hungry spider" className="flex-1 animate-fadeOut3" width={75} height={75} />
                                <button type="button" className="flex-1 bg-spaceGold border border-blueBlack border-2 text-blueBlack p-1 rounded animate-fadeOut2">Run</button>
                                <Image src="/images/orange-eye-spider.png" alt="hungry spider" className="flex-1 transform animate-fadeOut4" width={75} height={75} />
                                <Image src="/images/orange-eye-spider.png" alt="hungry spider" className="flex-1 transform animate-fadeOut25" width={75} height={75} />
                                <Image src="/images/orange-eye-spider.png" alt="hungry spider" className="flex-1 animate-fadeOut3" width={75} height={75} />
                                <Image src="/images/orange-eye-spider.png" alt="hungry spider" className="flex-1 transform animate-fadeOut4" width={75} height={75} />
                                ...
                                <button type="button" className="flex-1 bg-spaceGold border border-blueBlack border-2 text-blueBlack p-1 rounded animate-fadeOut3">Dinner</button>
                            </div>
